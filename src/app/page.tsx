    ...
    return (
        <>
            <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
                <div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:bg-gray-300 hover:bg-white/50">
                ...
                <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
                    Quills allow you to have conversation with any pdf document. Simply uploading your file and start asking
                    ...
                    <li className="md:flex-1">
                        <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pt-4">
                            ...
                            <span className="mt-2 text-zinc-700">
                                ...
                                <Link href="/pricing" className="pl-1 text-blue-700 underline underline-offset-2">
                                    pro plan
                                </Link>
                                .
                            </span>
