            ...
            {combinedMessages && combinedMessages.length > 0 ? (
                combinedMessages.map((message, i) => {
                    ...
                    if (i === combinedMessages.length - 1) {
                        return (
                            <Message key={i} isNextMessageSamePerson={isNextMessageSamePerson} message={message} ref={ref} />
                        );
                    } else {
                        return <Message key={i} isNextMessageSamePerson={isNextMessageSamePerson} message={message} />;
                    }
                })
            ) : isLoading ? (
